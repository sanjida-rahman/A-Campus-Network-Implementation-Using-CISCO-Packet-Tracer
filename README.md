...
Designed a campus network consisting of two departments and an admin office using CISCO packet tracer simulation software.
...
• A PT-router is used for the admin office which is connected to three networks. The networks are Fast Ethernet0/0, Serial 2/0 and Se3/0, the network addresses are 190.168.20.0, 20.20.20.0/ and 20.20.20.0 
respectively.
